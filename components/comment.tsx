...
const CommentBlock = () => {
  return (
    <div className="relative my-[40px] flex w-full max-w-[610px] flex-col items-center justify-center pl-4 after:absolute after:left-0 after:h-full after:w-[4px] after:bg-neutral-400/50 max-[655px]:px-4 max-[655px]:after:left-4">
      <blockquote className="font-sans text-sm/[150%] tracking-[0.01em] text-neutral-700 before:content-[open-quote] after:content-[close-quote] max-[655px]:pl-4 dark:text-neutral-200">
      ...
      <div className="mt-4 flex w-full flex-wrap items-center justify-between gap-4 border-t border-neutral-200 pt-4 max-[655px]:pl-4 dark:border-neutral-800">
        <div className="flex items-center gap-2">
          ...
          <p className="text-[13px] tracking-[0.01em] text-neutral-600 dark:text-neutral-400">
