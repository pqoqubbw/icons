  ...
  return (
    <div className="mx-auto mt-8 flex w-full max-w-[1016px] flex-col items-center gap-6 px-4">
      ...
      >
        ...
        >
          <div className="flex items-center justify-between px-[70px] pt-[38px]">
            <p className="font-sans text-[42px] text-[#525252] dark:text-[#D4D4D4]">
              Chill Guy Certificate
            </p>
            <p className="font-sans text-[24px] text-[#737373] dark:text-[#D4D4D4]">
              Supporter
            </p>
          </div>
          <div
              ...
              >
                <g clipPath="url(#clip0_143_5174)">
                  ...
                  <path
                    ...
                    fill="#EE4822"
                  />
                  <circle cx="91.0027" cy="155.021" r="18.3677" fill="white" />
                  <circle cx="140.3" cy="155.021" r="18.3677" fill="white" />
                  <circle
                    cx="92.6623"
                    cy="157.391"
                    r="5.33255"
                ...
                <defs>
                  <clipPath id="clip0_143_5174">
                    <rect width="220" height="242" rx="30" fill="white" />
                  </clipPath>
                </defs>
              </svg>
            </div>
            <div className="flex flex-col gap-[18px]">
              <h3 className="font-sans text-[42px] text-[#0A0A0A] dark:text-white">
                <span className="tabular-nums">
                  {formatCurrency(Number(selectedAmount))}
                </span>{' '}
                Donation
              </h3>
              <p className="max-w-[345px] font-mono text-[14px] text-[#404040] dark:text-[#D4D4D4]">
              ...
              <a
                ...
                className="bg-primary mt-[16px] flex w-fit cursor-pointer items-center justify-center px-[24px] py-[8px] font-sans text-[18px] text-white transition-colors duration-50 hover:bg-[color-mix(in_oklab,var(--color-primary),black_10%)]"
              >
                Sponsor
              </a>
            </div>
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="bg-primary supports-[corner-shape:squircle]:corner-squircle hidden w-full cursor-pointer items-center justify-center rounded-[12px] px-[24px] py-[8px] font-sans text-[18px] text-white transition-colors duration-50 hover:bg-[color-mix(in_oklab,var(--color-primary),black_10%)] supports-[corner-shape:squircle]:rounded-[20px] max-[610px]:flex"
      >
        Sponsor
      </a>
    </div>
